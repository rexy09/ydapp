...
class TripBookingDetails extends StatefulWidget {
  final Map<String, dynamic> bookingData;
  const TripBookingDetails({super.key, required this.bookingData});

  @override
  State<TripBookingDetails> createState() => _TripBookingDetailsState();
}

class _TripBookingDetailsState extends State<TripBookingDetails> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.portrait_outlined,
